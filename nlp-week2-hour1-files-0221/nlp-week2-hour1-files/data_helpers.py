...
# Tokenization/string cleaning for datasets (week 5 / hour 1)
...
def load_data_and_labels():
    #Loads polarity data from files, splits the data into words 
    #and generates labels. Returns split sentences and labels.
...
def pad_sentences(sentences, padding_word="<PAD/>"):
    #Pads all sentences to the same length (defined by the longest sentence)
